...
def main():
    ...
    ack_report_computed_task_timestamp = timestamp_to_isoformat(
        current_time - cluster_consts.subtask_verification_time - TIME_GUARD)  # now - SVT - TIME_GUARD (~4:00:10)
    report_computed_task_timestamp = ack_report_computed_task_timestamp   # now - SVT - TIME_GUARD (~4:00:10)
    task_to_compute_timestamp = timestamp_to_isoformat(
        current_time - cluster_consts.subtask_verification_time - 2 * TIME_GUARD)  # now - SVT - 2* TIME_GUARD (~4:00:20)
