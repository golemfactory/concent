...
def test_case_2d_requestor_rejects_subtask_results(cluster_consts, cluster_url, test_id):
    ...
    api_request(
        ...
        expected_status=200,
        expected_message_type=message.concents.ForceSubtaskResults.header.type_,
    ...
    api_request(
        ...
        expected_status=200,
        expected_message_type=message.concents.ForceSubtaskResultsResponse.header.type_,
        expected_content_type='application/octet-stream',
    )
...
def test_case_2c_wrong_timestamps(cluster_consts, cluster_url, test_id):
    ...
    api_request(
        ...
        expected_status=200,
        expected_message_type=message.concents.ForceSubtaskResultsRejected.header.type_,
        expected_content_type='application/octet-stream',
    )
...
def test_case_2b_not_enough_funds(cluster_consts, cluster_url, test_id):
    ...
    api_request(
        ...
        expected_status=200,
        expected_message_type=message.concents.ServiceRefused.header.type_,
        expected_content_type='application/octet-stream',
    )
