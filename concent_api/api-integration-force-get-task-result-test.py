...
def test_case_1_test_for_existing_file(cluster_consts, cluster_url, test_id):
    ...
    api_request(
        ...
        expected_status=200,
        expected_message_type=message.concents.AckForceGetTaskResult.header.type_,
    ...
    force_get_task_result_upload = api_request(
        ...
        expected_status=200,
        expected_message_type=message.concents.ForceGetTaskResultUpload.header.type_,
        expected_content_type='application/octet-stream',
    )
    ...
    api_request(
        ...
        expected_status=200,
        expected_message_type=message.concents.ForceGetTaskResultDownload.header.type_,
        expected_content_type='application/octet-stream',
    )
