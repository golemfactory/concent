...
import command_line_tool.key_manager as key_manager
...
class TestKeyManager(TestCase):
    ...
    def test_that_requestor_predefined_keys_are_returned_when_set(self):
        key_manager.CONFIG['REQUESTOR_PUBLIC_KEY'] = PREDEFINED_REQUESTOR_PUBLIC_KEY
        key_manager.CONFIG['REQUESTOR_PRIVATE_KEY'] = PREDEFINED_REQUESOTR_PRIVATE_KEY
        requestor_public_key, requestor_private_key = key_manager.KeyManager().get_requestor_keys()
    ...
    def test_that_provider_predefined_keys_are_returned_when_set(self):
        key_manager.CONFIG['PROVIDER_PUBLIC_KEY'] = PREDEFINED_PROVIDER_PUBLIC_KEY
        key_manager.CONFIG['PROVIDER_PRIVATE_KEY'] = PREDEFINED_PROVIDER_PRIVATE_KEY
        provider_public_key, provider_private_key = key_manager.KeyManager().get_provider_keys()
