...
def _update_timed_out_subtask_500_mock(_client_public_key):
...
def _update_timed_out_subtask_400_mock(_client_public_key):
    Client.objects.get_or_create_full_clean(
        CONCENT_PUBLIC_KEY
    )
...
def _update_timed_out_subtask_correct_response_mock(_client_public_key):
    Client.objects.get_or_create_full_clean(
        CONCENT_PUBLIC_KEY
    )
