...
def create_error_1_concent_features_is_not_a_list() -> Error:
    return Error(
...
def create_error_2_unknown_features_specifed_in_concent_features() -> Error:
    return Error(
...
def create_error_3_features_are_not_enabled_in_installed_apps(feature: str) -> Error:
    return Error(
...
def create_error_4_if_geth_container_address_has_wrong_value() -> Error:
    return Error(
...
def create_error_5_invalid_setting_type(setting: str, value: str) -> Error:
    return Error(
...
def create_error_6_if_minimum_upload_rate_is_not_set() -> Error:
    return Error(
...
def create_error_7_if_minimum_upload_rate_has_wrong_value() -> Error:
    return Error(
...
def create_error_8_if_download_leadin_time_is_not_set() -> Error:
    return Error(
...
def create_error_9_if_download_leadin_time_has_wrong_value() -> Error:
    return Error(
...
def create_error_10_if_concent_time_settings_is_not_defined(concent_setting_name: str) -> Error:
    return Error(
...
def create_error_11_if_concent_time_settings_have_wrong_value(concent_setting_name: str) -> Error:
    return Error(
...
def create_error_12_atomic_requests_not_set_for_database(database_name: str) -> Error:
    return Error(
...
def create_error_13_storage_server_internal_address_is_not_set() -> Error:
    return Error(
...
def create_error_14_storage_server_internal_address_is_not_valid_url(error: str) -> Error:
    return Error(
...
def create_error_15_verifier_storage_path_is_not_set() -> Error:
    return Error(
...
def create_error_16_verifier_storage_path_is_does_not_exists() -> Error:
    return Error(
...
def create_error_17_verifier_storage_path_is_not_accessible() -> Error:
    return Error(
...
def create_error_18_custom_protocol_times_is_not_set() -> Error:
    return Error(
...
def create_error_19_custom_protocol_times_has_wrong_value() -> Error:
    return Error(
...
def create_error_20_custom_protocol_times_is_false_and_settings_does_not_match_golem_messages_constants(
...
def create_error_22_verifier_min_ssim_has_wrong_value(verifier_min_ssim: float) -> Error:
    return Error(
...
def create_error_23_additional_verification_time_multiplier_is_not_defined() -> Error:
    return Error(
...
def create_error_24_additional_verification_time_multiplier_has_wrong_type(
...
def create_error_25_storage_cluster_address_does_not_end_with_slash() -> Error:
    return Error(
...
def create_error_26_storage_server_internal_address_does_not_end_with_slash() -> Error:
    return Error(
...
def create_error_27_storage_cluster_address_is_not_valid_url(error: ValidationError) -> Error:
    return Error(
...
def create_error_28_storage_cluster_address_is_not_set() -> Error:
    return Error(
...
def create_error_29_verifier_download_chunk_size_is_not_defined() -> Error:
    return Error(
...
def create_error_30_verifier_download_chunk_size_has_wrong_type(verifier_download_chunk_size_type: Any) -> Error:
    return Error(
...
def create_error_31_verifier_download_chunk_size_has_wrong_value(verifier_download_chunk_size_value: int) -> Error:
    return Error(
...
def create_error_32_signing_service_public_key_is_missing() -> Error:
    return Error(
...
def create_error_33_signing_service_public_key_is_invalid() -> Error:
    return Error(
...
def create_error_34_concent_ethereum_public_key_is_not_set() -> Error:
    return Error(
...
def create_error_35_concent_ethereum_public_key_has_wrong_type(concent_ethereum_public_key: Any) -> Error:
    return Error(
...
def create_error_36_concent_ethereum_public_key_has_wrong_length(concent_ethereum_public_key: str) -> Error:
    return Error(
...
def create_error_37_middleman_address_has_wrong_type(value: Any) -> Error:
    return Error(
...
def create_error_38_middleman_address_is_not_set() -> Error:
    return Error(
...
def create_error_39_middleman_port_is_not_set() -> Error:
    return Error(
...
def create_error_40_middleman_port_has_wrong_type(value: Any) -> Error:
    return Error(
...
def create_error_41_middleman_port_has_wrong_value(value: int) -> Error:
    return Error(
...
def create_error_42_use_signing_service_not_set() -> Error:
    return Error(
...
def create_error_43_use_signing_service_has_wrong_type(value: Any) -> Error:
    return Error(
...
def create_error_44_use_signing_service_is_true_but_middleman_is_missing() -> Error:
    return Error(
...
def create_error_45_gntdeposit_not_set() -> Error:
    return Error(
...
def create_error_46_gntdeposit_has_wrong_type(value: Any) -> Error:
    return Error(
...
def create_error_47_gntdeposit_wrong_value(value: Any) -> Error:
    return Error(
...
def create_error_48_additional_verification_cost_is_not_defined() -> Error:
    return Error(
...
def create_error_49_additional_verification_cost_is_not_non_negative_integer() -> Error:
    return Error(
...
def create_error_50_additional_verification_call_time_is_not_set() -> Error:
    return Error(
...
def create_error_51_additional_verification_call_time_has_wrong_value() -> Error:
    return Error(
...
def create_error_52_sci_callback_retries_is_not_set() -> Error:
    return Error(
...
def create_error_53_sci_callback_retries_has_wrong_value() -> Error:
    return Error(
...
def create_error_54_ssl_cert_path_is_none() -> Error:
    return Error(
...
def create_error_55_cert_path_does_not_exist(path: str) -> Error:
    return Error(
...
def create_error_56_ssl_cert_path_is_not_a_file(path: str) -> Error:
    return Error(
...
def create_error_57_payment_backend_is_not_set() -> Error:
    return Error(
...
def create_error_58_payment_backend_is_not_a_valid_python_module(error: ImportError) -> Error:
    return Error(
...
def check_settings_concent_features(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    ...
    if not isinstance(settings.CONCENT_FEATURES, list):
        return [create_error_1_concent_features_is_not_a_list()]

    uknown_features = set(settings.CONCENT_FEATURES) - AVAILABLE_CONCENT_FEATURES.keys()
    if len(uknown_features) > 0:
        return [create_error_2_unknown_features_specifed_in_concent_features()]

    errors_and_warnings = []
    if len(set(settings.CONCENT_FEATURES)) != len(settings.CONCENT_FEATURES):
        errors_and_warnings.append(create_warning_1_multiple_features_in_concent_feature())
    ...
    for feature in settings.CONCENT_FEATURES:
        if not set(AVAILABLE_CONCENT_FEATURES[feature]['required_django_apps']).issubset(set(settings.INSTALLED_APPS)):  # type: ignore
            errors_and_warnings.append(create_error_3_features_are_not_enabled_in_installed_apps(feature))
...
def check_settings_storage_cluster_address(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    if not hasattr(settings, 'STORAGE_CLUSTER_ADDRESS') and 'gatekeeper' in settings.CONCENT_FEATURES:
        return [create_error_28_storage_cluster_address_is_not_set()]
    ...
    if hasattr(settings, 'STORAGE_CLUSTER_ADDRESS'):
        ...
        try:
            ...
            return [create_error_27_storage_cluster_address_is_not_valid_url(error)]
        if not settings.STORAGE_CLUSTER_ADDRESS.endswith('/'):
            return [create_error_25_storage_cluster_address_does_not_end_with_slash()]
...
def check_settings_storage_server_internal_address(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    if not hasattr(settings, 'STORAGE_SERVER_INTERNAL_ADDRESS') and 'verifier' in settings.CONCENT_FEATURES:
        return [create_error_13_storage_server_internal_address_is_not_set()]
    ...
    if hasattr(settings, 'STORAGE_SERVER_INTERNAL_ADDRESS'):
        ...
        try:
            ...
            return [create_error_14_storage_server_internal_address_is_not_valid_url(error)]
        if not settings.STORAGE_SERVER_INTERNAL_ADDRESS.endswith('/'):
            return [create_error_26_storage_server_internal_address_does_not_end_with_slash()]
...
def check_settings_verifier_storage_path(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    if not hasattr(settings, 'VERIFIER_STORAGE_PATH') and 'verifier' in settings.CONCENT_FEATURES:
        return [create_error_15_verifier_storage_path_is_not_set()]

    if hasattr(settings, 'VERIFIER_STORAGE_PATH'):
        if not os.path.exists(settings.VERIFIER_STORAGE_PATH):
            return [create_error_16_verifier_storage_path_is_does_not_exists()]
        if not os.access(settings.VERIFIER_STORAGE_PATH, os.W_OK):
            return [create_error_17_verifier_storage_path_is_not_accessible()]
...
def check_payment_backend(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    if 'concent-api' in settings.CONCENT_FEATURES and (
        ...
        return [create_error_57_payment_backend_is_not_set()]

    try:
        importlib.import_module(settings.PAYMENT_BACKEND)
    except ImportError as error:
        return [create_error_58_payment_backend_is_not_a_valid_python_module(error)]
...
def storage_cluster_certificate_path_check(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    ...
    if certificate_path != '':
        if certificate_path is None:
            errors.append(create_error_54_ssl_cert_path_is_none())
        elif not os.path.exists(certificate_path):
            errors.append(create_error_55_cert_path_does_not_exist(certificate_path))
        elif not os.path.isfile(certificate_path):
            errors.append(create_error_56_ssl_cert_path_is_not_a_file(certificate_path))
    return errors
    ...
    if (
        ...
        if hasattr(settings, 'GETH_ADDRESS'):
            ...
            try:
                ...
                return [create_error_4_if_geth_container_address_has_wrong_value()]
        else:
            return [create_error_4_if_geth_container_address_has_wrong_value()]
    return []
        ...
        for database_name, database_config in settings.DATABASES.items():
            ...
            if database_config.get('ENGINE') != 'django.db.backends.dummy':
                ...
                if not isinstance(atomic_requests, bool):
                    errors.append(create_error_5_invalid_setting_type(
                        f"DATABASES[{database_name}]['ATOMIC_REQUESTS']",
                        atomic_requests)
                    )

                if not atomic_requests:
                    errors.append(create_error_12_atomic_requests_not_set_for_database(database_name))
    return errors
...
def check_minimum_upload_rate(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    ...
    if not hasattr(settings, 'MINIMUM_UPLOAD_RATE'):
        return [create_error_6_if_minimum_upload_rate_is_not_set()]
    if not isinstance(settings.MINIMUM_UPLOAD_RATE, int) or settings.MINIMUM_UPLOAD_RATE < 1:
        return [create_error_7_if_minimum_upload_rate_has_wrong_value()]
    return errors
...
def check_download_leadin_time(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    ...
    if not hasattr(settings, 'DOWNLOAD_LEADIN_TIME'):
        return [create_error_8_if_download_leadin_time_is_not_set()]
    if not isinstance(settings.DOWNLOAD_LEADIN_TIME, int) or settings.DOWNLOAD_LEADIN_TIME < 0:
        return [create_error_9_if_download_leadin_time_has_wrong_value()]
    return errors
...
def check_concents_time_settings(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    ...
    for concent_setting in CONCENT_TIME_SETTINGS:
        if not hasattr(settings, concent_setting):
            settings_not_defined.append(create_error_10_if_concent_time_settings_is_not_defined(concent_setting))
        else:
            if not isinstance(getattr(settings, concent_setting), int) or getattr(settings, concent_setting) < 0:
                settings_wrong_value.append(create_error_11_if_concent_time_settings_have_wrong_value(concent_setting))
...
def check_custom_protocol_times(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    ...
    if not hasattr(settings, 'CUSTOM_PROTOCOL_TIMES'):
        return [create_error_18_custom_protocol_times_is_not_set()]
    if not isinstance(settings.CUSTOM_PROTOCOL_TIMES, bool):
        return [create_error_19_custom_protocol_times_has_wrong_value()]
...
def check_verifier_min_ssim(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    if hasattr(settings, 'VERIFIER_MIN_SSIM') and settings.VERIFIER_MIN_SSIM is not None:
        if not isinstance(settings.VERIFIER_MIN_SSIM, float):
            return [create_error_21_verifier_min_ssim_has_wrong_type()]
        if not -1 <= settings.VERIFIER_MIN_SSIM <= 1:
            return [create_error_22_verifier_min_ssim_has_wrong_value(settings.VERIFIER_MIN_SSIM)]
...
def check_additional_verification_time_multiplier(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    if not hasattr(settings, 'ADDITIONAL_VERIFICATION_TIME_MULTIPLIER'):
        return [create_error_23_additional_verification_time_multiplier_is_not_defined()]
    if not isinstance(settings.ADDITIONAL_VERIFICATION_TIME_MULTIPLIER, float):
        return [create_error_24_additional_verification_time_multiplier_has_wrong_type(
...
def check_verifier_download_chunk_size(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    if 'verifier' in settings.CONCENT_FEATURES:
        if not hasattr(settings, 'VERIFIER_DOWNLOAD_CHUNK_SIZE'):
            return [create_error_29_verifier_download_chunk_size_is_not_defined()]
        if not isinstance(settings.VERIFIER_DOWNLOAD_CHUNK_SIZE, int):
            return [create_error_30_verifier_download_chunk_size_has_wrong_type(
                type(settings.VERIFIER_DOWNLOAD_CHUNK_SIZE)
            )]
        if settings.VERIFIER_DOWNLOAD_CHUNK_SIZE < 1:
            return [create_error_31_verifier_download_chunk_size_has_wrong_value(
...
def check_signing_service_key_availability_for_middleman(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    ...
    if "middleman" in settings.CONCENT_FEATURES:
        if not hasattr(settings, "SIGNING_SERVICE_PUBLIC_KEY"):
            errors.append(create_error_32_signing_service_public_key_is_missing())
        else:
            try:
                validate_bytes_public_key(settings.SIGNING_SERVICE_PUBLIC_KEY, "SIGNING_SERVICE_PUBLIC_KEY")
            except ConcentValidationError:
                errors.append(create_error_33_signing_service_public_key_is_invalid())
    return errors
...
def check_concent_ethereum_public_key(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    if not hasattr(settings, 'CONCENT_ETHEREUM_PUBLIC_KEY') and 'core' in settings.CONCENT_FEATURES:
        return [create_error_34_concent_ethereum_public_key_is_not_set()]

    if hasattr(settings, 'CONCENT_ETHEREUM_PUBLIC_KEY'):
        if not isinstance(settings.CONCENT_ETHEREUM_PUBLIC_KEY, str):
            return [create_error_35_concent_ethereum_public_key_has_wrong_type(settings.CONCENT_ETHEREUM_PUBLIC_KEY)]
        if len(settings.CONCENT_ETHEREUM_PUBLIC_KEY) != ETHEREUM_PUBLIC_KEY_LENGTH:
            return [create_error_36_concent_ethereum_public_key_has_wrong_length(settings.CONCENT_ETHEREUM_PUBLIC_KEY)]
...
def check_middleman_address(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    if 'concent-api' in settings.CONCENT_FEATURES and 'concent-worker' in settings.CONCENT_FEATURES:
        if not hasattr(settings, 'MIDDLEMAN_ADDRESS'):
            return [create_error_38_middleman_address_is_not_set()]
        if not isinstance(settings.MIDDLEMAN_ADDRESS, str):
            return [create_error_37_middleman_address_has_wrong_type(settings.MIDDLEMAN_ADDRESS)]
...
def check_middleman_port(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    if 'concent-api' in settings.CONCENT_FEATURES and 'concent-worker' in settings.CONCENT_FEATURES:
        if not hasattr(settings, 'MIDDLEMAN_PORT'):
            return [create_error_39_middleman_port_is_not_set()]
        if not isinstance(settings.MIDDLEMAN_PORT, int):
            return [create_error_40_middleman_port_has_wrong_type(settings.MIDDLEMAN_PORT)]
        if not 0 < settings.MIDDLEMAN_PORT < 65535:
            return [create_error_41_middleman_port_has_wrong_value(settings.MIDDLEMAN_PORT)]
...
def check_use_signing_service(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    if (
        ...
        if not hasattr(settings, 'USE_SIGNING_SERVICE'):
            return [create_error_42_use_signing_service_not_set()]

        if not isinstance(settings.USE_SIGNING_SERVICE, bool):
            return [create_error_43_use_signing_service_has_wrong_type(settings.USE_SIGNING_SERVICE)]

        if settings.USE_SIGNING_SERVICE is True and 'middleman' not in settings.CONCENT_FEATURES:
            return [create_error_44_use_signing_service_is_true_but_middleman_is_missing()]
...
def check_gntdeposit_adress(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    if (
        ...
        if not hasattr(settings, 'GNT_DEPOSIT_CONTRACT_ADDRESS'):
            return [create_error_45_gntdeposit_not_set()]

        if not isinstance(settings.GNT_DEPOSIT_CONTRACT_ADDRESS, str):
            return [create_error_46_gntdeposit_has_wrong_type(settings.GNT_DEPOSIT_CONTRACT_ADDRESS)]

        if settings.GNT_DEPOSIT_CONTRACT_ADDRESS[:2] != '0x' or len(settings.GNT_DEPOSIT_CONTRACT_ADDRESS) != 42:
            return [create_error_47_gntdeposit_wrong_value(settings.GNT_DEPOSIT_CONTRACT_ADDRESS)]
...
def check_additional_verification_cost(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    if 'concent-api' in settings.CONCENT_FEATURES:
        if not hasattr(settings, 'ADDITIONAL_VERIFICATION_COST'):
            return [create_error_48_additional_verification_cost_is_not_defined()]
        if not isinstance(settings.ADDITIONAL_VERIFICATION_COST, int) or settings.ADDITIONAL_VERIFICATION_COST < 0:
            return [create_error_49_additional_verification_cost_is_not_non_negative_integer()]
...
def check_additional_verification_call_time(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    ...
    if not hasattr(settings, 'ADDITIONAL_VERIFICATION_CALL_TIME'):
        return [create_error_50_additional_verification_call_time_is_not_set()]
    if not isinstance(settings.ADDITIONAL_VERIFICATION_CALL_TIME, int) or settings.ADDITIONAL_VERIFICATION_CALL_TIME < 0:
        return [create_error_51_additional_verification_call_time_has_wrong_value()]
    return errors
...
def check_sci_callback_retries(app_configs: None=None, **kwargs: Any) -> list:  # pylint: disable=unused-argument
    if 'concent-api' in settings.CONCENT_FEATURES:
        if not hasattr(settings, 'SCI_CALLBACK_RETRIES_TIME'):
            return [create_error_52_sci_callback_retries_is_not_set()]
        if (
